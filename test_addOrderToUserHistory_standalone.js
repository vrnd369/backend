...
async function testAddOrderToUserHistoryStandalone() {
  console.log('🔍 Testing addOrderToUserHistory function standalone...\n');
  ...
  try {
    ...
    const mockOrder = {
      orderId: `STANDALONE-TEST-${Date.now()}`,
      total: 399,
      ...
      items: [
        {
          productId: 'standalone-test-product',
          id: 'standalone-test-product',
          title: 'Standalone Test Product',
          quantity: 1,
          price: 399,
          img: 'https://example.com/standalone.jpg'
        }
      ]
    };
...
testAddOrderToUserHistoryStandalone(); 