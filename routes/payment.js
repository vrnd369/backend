      ...
      try {
        ...
        if (trackingUpdates) {
          ...
          if (trackingUpdates.trackingNumber && trackingUpdates.trackingNumber !== order.trackingNumber) {
            ...
            updated = true;
            console.log('✅ Auto-updated tracking number:', trackingUpdates.trackingNumber);
          }
          ...
          if (trackingUpdates.courierName && trackingUpdates.courierName !== order.courierName) {
            ...
            updated = true;
            console.log('✅ Auto-updated courier name:', trackingUpdates.courierName);
          }
          ...
          if (trackingUpdates.trackingUrl && trackingUpdates.trackingUrl !== order.trackingUrl) {
            ...
            updated = true;
            console.log('✅ Auto-updated tracking URL:', trackingUpdates.trackingUrl);
          }
          ...
          if (updated) {
            ...
            console.log('ℹ️ No new tracking updates available');
          }
        } else {
