...
async function testDatabaseDataSimple() {
  try {
    console.log('🚀 Testing Database Data (Simple)...\n');
    ...
    // Step 2: Create regular order (without payment verification)
    console.log('\n2. Creating regular order...');
    ...
    // Step 4: Check User data with order history
    console.log('\n4. Checking User data with order history...');
    ...
    // Step 5: Check all user orders
    console.log('\n5. Checking all user orders...');
    ...
    console.log('\n🎉 SUCCESS: Database data verification completed!');
